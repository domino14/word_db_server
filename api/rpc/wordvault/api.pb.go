...
var file_rpc_wordvault_api_proto_rawDesc = []byte{
	...
	0x0d, 0x52, 0x05, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x2e, 0x0a, 0x05, 0x43, 0x61, 0x72, 0x64,
	...
	0x72, 0x64, 0x4a, 0x73, 0x6f, 0x6e, 0x52, 0x65, 0x70, 0x72, 0x22, 0x4b, 0x0a, 0x0f, 0x41, 0x64,
	...
	0x68, 0x61, 0x67, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x3a, 0x0a, 0x10, 0x41, 0x64, 0x64, 0x43, 0x61,
	...
	0x64, 0x65, 0x64, 0x22, 0xa3, 0x01, 0x0a, 0x14, 0x45, 0x64, 0x69, 0x74, 0x4c, 0x61, 0x73, 0x74,
	...
	0x6d, 0x50, 0x6f, 0x73, 0x74, 0x70, 0x6f, 0x6e, 0x65, 0x64, 0x22, 0x57, 0x0a, 0x0d, 0x44, 0x65,
	...
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x2a, 0x58, 0x0a, 0x05, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12,
	...
	0x32, 0xc0, 0x05, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x64, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x53, 0x65,
	...
	0x43, 0x0a, 0x08, 0x50, 0x6f, 0x73, 0x74, 0x70, 0x6f, 0x6e, 0x65, 0x12, 0x1a, 0x2e, 0x77, 0x6f,
	...
	0x75, 0x6c, 0x74, 0x2e, 0x50, 0x6f, 0x73, 0x74, 0x70, 0x6f, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70,
	...
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x77, 0x6f, 0x72, 0x64, 0x76,
...
var file_rpc_wordvault_api_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_rpc_wordvault_api_proto_goTypes = []interface{}{
	...
	(*DeleteRequest)(nil),             // 16: wordvault.DeleteRequest
	(*DeleteResponse)(nil),            // 17: wordvault.DeleteResponse
	nil,                               // 18: wordvault.CardCountResponse.NumCardsEntry
	nil,                               // 19: wordvault.NextScheduledBreakdown.BreakdownEntry
	(*wordsearcher.Alphagram)(nil),    // 20: wordsearcher.Alphagram
	(*timestamppb.Timestamp)(nil),     // 21: google.protobuf.Timestamp
}
var file_rpc_wordvault_api_proto_depIdxs = []int32{
	20, // 0: wordvault.Card.alphagram:type_name -> wordsearcher.Alphagram
	1,  // 1: wordvault.Cards.cards:type_name -> wordvault.Card
	0,  // 2: wordvault.ScoreCardRequest.score:type_name -> wordvault.Score
	21, // 3: wordvault.ScoreCardResponse.next_scheduled:type_name -> google.protobuf.Timestamp
	0,  // 4: wordvault.EditLastScoreRequest.new_score:type_name -> wordvault.Score
	18, // 5: wordvault.CardCountResponse.num_cards:type_name -> wordvault.CardCountResponse.NumCardsEntry
	19, // 6: wordvault.NextScheduledBreakdown.breakdown:type_name -> wordvault.NextScheduledBreakdown.BreakdownEntry
	...
	16, // 15: wordvault.WordVaultService.Delete:input_type -> wordvault.DeleteRequest
	11, // 16: wordvault.WordVaultService.GetCardCount:output_type -> wordvault.CardCountResponse
	4,  // 17: wordvault.WordVaultService.GetCardInformation:output_type -> wordvault.Cards
	4,  // 18: wordvault.WordVaultService.GetNextScheduled:output_type -> wordvault.Cards
	13, // 19: wordvault.WordVaultService.NextScheduledCount:output_type -> wordvault.NextScheduledBreakdown
	6,  // 20: wordvault.WordVaultService.ScoreCard:output_type -> wordvault.ScoreCardResponse
	6,  // 21: wordvault.WordVaultService.EditLastScore:output_type -> wordvault.ScoreCardResponse
	8,  // 22: wordvault.WordVaultService.AddCards:output_type -> wordvault.AddCardsResponse
	15, // 23: wordvault.WordVaultService.Postpone:output_type -> wordvault.PostponeResponse
	17, // 24: wordvault.WordVaultService.Delete:output_type -> wordvault.DeleteResponse
