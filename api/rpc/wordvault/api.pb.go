...
var file_rpc_wordvault_api_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x57, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x77, 0x51, 0x75, 0x65, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x31, 0x0a, 0x0e, 0x44, 0x65,
	...
	0x0d, 0x52, 0x0a, 0x6e, 0x75, 0x6d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x2a, 0x58, 0x0a,
	...
	0x5f, 0x45, 0x41, 0x53, 0x59, 0x10, 0x04, 0x32, 0xb4, 0x06, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x64,
	...
	,
...
var file_rpc_wordvault_api_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_rpc_wordvault_api_proto_goTypes = []interface{}{
	...
	nil,                                    // 20: wordvault.CardCountResponse.NumCardsEntry
	nil,                                    // 21: wordvault.NextScheduledBreakdown.BreakdownEntry
	(*wordsearcher.Alphagram)(nil),         // 22: wordsearcher.Alphagram
	(*timestamppb.Timestamp)(nil),          // 23: google.protobuf.Timestamp
}
var file_rpc_wordvault_api_proto_depIdxs = []int32{
	22, // 0: wordvault.Card.alphagram:type_name -> wordsearcher.Alphagram
	...
	23, // 4: wordvault.ScoreCardResponse.next_scheduled:type_name -> google.protobuf.Timestamp
	0,  // 5: wordvault.EditLastScoreRequest.new_score:type_name -> wordvault.Score
	20, // 6: wordvault.CardCountResponse.num_cards:type_name -> wordvault.CardCountResponse.NumCardsEntry
	21, // 7: wordvault.NextScheduledBreakdown.breakdown:type_name -> wordvault.NextScheduledBreakdown.BreakdownEntry
	12, // 8: wordvault.WordVaultService.GetCardCount:input_type -> wordvault.GetCardCountRequest
	2,  // 9: wordvault.WordVaultService.GetCardInformation:input_type -> wordvault.GetCardInfoRequest
	3,  // 10: wordvault.WordVaultService.GetNextScheduled:input_type -> wordvault.GetNextScheduledRequest
	4,  // 11: wordvault.WordVaultService.GetSingleNextScheduled:input_type -> wordvault.GetSingleNextScheduledRequest
	14, // 12: wordvault.WordVaultService.NextScheduledCount:input_type -> wordvault.NextScheduledCountRequest
	7,  // 13: wordvault.WordVaultService.ScoreCard:input_type -> wordvault.ScoreCardRequest
	11, // 14: wordvault.WordVaultService.EditLastScore:input_type -> wordvault.EditLastScoreRequest
	9,  // 15: wordvault.WordVaultService.AddCards:input_type -> wordvault.AddCardsRequest
	16, // 16: wordvault.WordVaultService.Postpone:input_type -> wordvault.PostponeRequest
	18, // 17: wordvault.WordVaultService.Delete:input_type -> wordvault.DeleteRequest
	13, // 18: wordvault.WordVaultService.GetCardCount:output_type -> wordvault.CardCountResponse
	6,  // 19: wordvault.WordVaultService.GetCardInformation:output_type -> wordvault.Cards
	6,  // 20: wordvault.WordVaultService.GetNextScheduled:output_type -> wordvault.Cards
	5,  // 21: wordvault.WordVaultService.GetSingleNextScheduled:output_type -> wordvault.GetSingleNextScheduledResponse
	15, // 22: wordvault.WordVaultService.NextScheduledCount:output_type -> wordvault.NextScheduledBreakdown
	8,  // 23: wordvault.WordVaultService.ScoreCard:output_type -> wordvault.ScoreCardResponse
	8,  // 24: wordvault.WordVaultService.EditLastScore:output_type -> wordvault.ScoreCardResponse
	10, // 25: wordvault.WordVaultService.AddCards:output_type -> wordvault.AddCardsResponse
	17, // 26: wordvault.WordVaultService.Postpone:output_type -> wordvault.PostponeResponse
	19, // 27: wordvault.WordVaultService.Delete:output_type -> wordvault.DeleteResponse
