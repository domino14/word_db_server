...
const (
	...
	// WordVaultServiceGetDeckFsrsParametersProcedure is the fully-qualified name of the
	// WordVaultService's GetDeckFsrsParameters RPC.
	WordVaultServiceGetDeckFsrsParametersProcedure = "/wordvault.WordVaultService/GetDeckFsrsParameters"
	// WordVaultServiceEditDeckFsrsParametersProcedure is the fully-qualified name of the
	// WordVaultService's EditDeckFsrsParameters RPC.
	WordVaultServiceEditDeckFsrsParametersProcedure = "/wordvault.WordVaultService/EditDeckFsrsParameters"
...
var (
	...
	wordVaultServiceGetDeckFsrsParametersMethodDescriptor    = wordVaultServiceServiceDescriptor.Methods().ByName("GetDeckFsrsParameters")
	wordVaultServiceEditDeckFsrsParametersMethodDescriptor   = wordVaultServiceServiceDescriptor.Methods().ByName("EditDeckFsrsParameters")
...
type WordVaultServiceClient interface {
	...
	GetDeckFsrsParameters(context.Context, *connect.Request[wordvault.GetDeckFsrsParametersRequest]) (*connect.Response[wordvault.GetDeckFsrsParametersResponse], error)
	EditDeckFsrsParameters(context.Context, *connect.Request[wordvault.EditDeckFsrsParametersRequest]) (*connect.Response[wordvault.EditDeckFsrsParametersResponse], error)
...
func NewWordVaultServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) WordVaultServiceClient {
	...
	return &wordVaultServiceClient{
		...
		getDeckFsrsParameters: connect.NewClient[wordvault.GetDeckFsrsParametersRequest, wordvault.GetDeckFsrsParametersResponse](
			httpClient,
			baseURL+WordVaultServiceGetDeckFsrsParametersProcedure,
			connect.WithSchema(wordVaultServiceGetDeckFsrsParametersMethodDescriptor),
			connect.WithIdempotency(connect.IdempotencyNoSideEffects),
			connect.WithClientOptions(opts...),
		),
		editDeckFsrsParameters: connect.NewClient[wordvault.EditDeckFsrsParametersRequest, wordvault.EditDeckFsrsParametersResponse](
			httpClient,
			baseURL+WordVaultServiceEditDeckFsrsParametersProcedure,
			connect.WithSchema(wordVaultServiceEditDeckFsrsParametersMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
...
type wordVaultServiceClient struct {
	...
	getDeckFsrsParameters    *connect.Client[wordvault.GetDeckFsrsParametersRequest, wordvault.GetDeckFsrsParametersResponse]
	editDeckFsrsParameters   *connect.Client[wordvault.EditDeckFsrsParametersRequest, wordvault.EditDeckFsrsParametersResponse]
...
// GetDeckFsrsParameters calls wordvault.WordVaultService.GetDeckFsrsParameters.
func (c *wordVaultServiceClient) GetDeckFsrsParameters(ctx context.Context, req *connect.Request[wordvault.GetDeckFsrsParametersRequest]) (*connect.Response[wordvault.GetDeckFsrsParametersResponse], error) {
	return c.getDeckFsrsParameters.CallUnary(ctx, req)
}

// EditDeckFsrsParameters calls wordvault.WordVaultService.EditDeckFsrsParameters.
func (c *wordVaultServiceClient) EditDeckFsrsParameters(ctx context.Context, req *connect.Request[wordvault.EditDeckFsrsParametersRequest]) (*connect.Response[wordvault.EditDeckFsrsParametersResponse], error) {
	return c.editDeckFsrsParameters.CallUnary(ctx, req)
}
...
func NewWordVaultServiceHandler(svc WordVaultServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	wordVaultServiceGetDeckFsrsParametersHandler := connect.NewUnaryHandler(
		WordVaultServiceGetDeckFsrsParametersProcedure,
		svc.GetDeckFsrsParameters,
		connect.WithSchema(wordVaultServiceGetDeckFsrsParametersMethodDescriptor),
		connect.WithIdempotency(connect.IdempotencyNoSideEffects),
		connect.WithHandlerOptions(opts...),
	)
	wordVaultServiceEditDeckFsrsParametersHandler := connect.NewUnaryHandler(
		WordVaultServiceEditDeckFsrsParametersProcedure,
		svc.EditDeckFsrsParameters,
		connect.WithSchema(wordVaultServiceEditDeckFsrsParametersMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/wordvault.WordVaultService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case WordVaultServiceGetDeckFsrsParametersProcedure:
			wordVaultServiceGetDeckFsrsParametersHandler.ServeHTTP(w, r)
		case WordVaultServiceEditDeckFsrsParametersProcedure:
			wordVaultServiceEditDeckFsrsParametersHandler.ServeHTTP(w, r)
...
func (UnimplementedWordVaultServiceHandler) GetDeckFsrsParameters(context.Context, *connect.Request[wordvault.GetDeckFsrsParametersRequest]) (*connect.Response[wordvault.GetDeckFsrsParametersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("wordvault.WordVaultService.GetDeckFsrsParameters is not implemented"))
}

func (UnimplementedWordVaultServiceHandler) EditDeckFsrsParameters(context.Context, *connect.Request[wordvault.EditDeckFsrsParametersRequest]) (*connect.Response[wordvault.EditDeckFsrsParametersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("wordvault.WordVaultService.EditDeckFsrsParameters is not implemented"))
}
