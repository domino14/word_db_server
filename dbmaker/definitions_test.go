...
func TestExpandPartSimpleLinks(t *testing.T) {
	...
	def := expandRaw(sd.raw, "HIPNESS", definitions, make(map[string]bool))
	assert.Equal(t,
...
func TestExpandPartMultipleLinks(t *testing.T) {
	...
	def := expandRaw(sd.raw, "RUM", definitions, make(map[string]bool))
	assert.Equal(t,
...
func TestUnescapeHtmlEntity(t *testing.T) {
	...
	expanded := expandRaw(def, "MOI", nil, make(map[string]bool))
	assert.Equal(t,
...
func TestExpandRootLink(t *testing.T) {
	...
	expanded := expandRaw(sd.raw, "EMEERS", definitions, make(map[string]bool))
	assert.Equal(t,
...
func TestExpandMatchDeclensions(t *testing.T) {
	...
	expanded := expandRaw(`<os=n> [n]`, "ORA", definitions, make(map[string]bool))
	assert.Equal(t,
		`OS, an orifice (a mouth or mouthlike opening) [n]`, expanded)

	expanded = expandRaw(`<os=n> [n]`, "OSSA", definitions, make(map[string]bool))
	assert.Equal(t, `OS, a bone [n]`, expanded)

	expanded = expandRaw(`<os=n> [n]`, "OSAR", definitions, make(map[string]bool))
